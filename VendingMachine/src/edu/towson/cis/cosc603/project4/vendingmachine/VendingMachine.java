...
//	private static final double INITIAL_BALANCE = 0;
	 ...
	 * Postcondition: all entries in itemArray are null, 
	 */
	...
	/**
	 * Default new constructor for the vending machine. Precondition: It sets the balance not 
	 * to be less than zero and also to be greater or equal to zero
	 * Postcondition: sets the initial balance.
	 */
	public VendingMachine(double initialBalance){
		   	      if ((this.balance = initialBalance ) >= 0.0 ) {
